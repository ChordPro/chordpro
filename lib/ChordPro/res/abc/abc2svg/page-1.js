...
page.hf+'</g>\n</svg>')
page.hmax-=h;page.hf=''}else{abc2svg.page.user_out('<svg xmlns="http://www.w3.org/2000/svg" version="1.1"\n\
 xmlns:xlink="http://www.w3.org/1999/xlink"\n\
...
return}
cfmt.pageheight=v
if(!page&&user.img_out&&abc2svg.abc_end){this.page=page={abc:this,topmargin:38,botmargin:38,h:0,pn:0,pna:0,first:true}
