...
cfmt.temper=tb40(qs)
break}},set_vp:function(of,a){var i,item,s,abc=this,curvoice=this.get_curvoice()
if(curvoice.st==undefined){var st=0,vtb=abc.get_voice_tb()
for(i=0;i<vtb.length;i++){if(vtb[i].st!=undefined&&vtb[i].st>st)
st=vtb[i].st}
