...
abc2svg.grid={cs_sel0:/[\[(][^)]*[\])]/,cs_sel1:/[^[(]*[\[(]|[\])][\s\S]*/g,pl:'<path class="stroke" stroke-width="1" d="M',block_gen:function(of,s){if(s.subtype!="grid"){of(s)
return}
...
function cs_filter(a_cs,sel){var i,cs,tcs
...
return tcs
return tcs.replace(sel?abc2svg.grid.cs_sel1:abc2svg.grid.cs_sel0,'')}
