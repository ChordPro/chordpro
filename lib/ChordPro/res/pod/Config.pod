...
=encoding UTF8
    ...
    delegates {
        ...
        abc {
            ...
            // The result produced by the delegate handler. Default is to ignore this section.
    	type : ignore
    
    	// HTML and PDF can handle ABC sections as SVG images.
    	html.type : image
            pdf.type  : image
    	...
    	// HTML and PDF can handle Lilypond sections as SVG images.
    	html.type : image
            pdf.type  : image
    ...
    // Settings for HTML5 output.
    html5 {
    
        // Optional cover section.
        cover : false
    
        // Optional front matter section.
        front-matter : false
    
        // Optional back matter section.
        back-matter : false
    
        // Output mode. Use `print`/`paged` for the paged HTML5 path
        mode : print
    
        // HTML5-specific diagram settings.
        diagrams.direction : vertical
        ...
        // Templates for HTML5 generation.
        templates {
        ...
        // Settings for paged HTML5 output.
        paged {
            papersize             : null
            margintop             : null
            marginbottom          : null
            ...
            headspace             : null
            footspace             : null
            song.page-break       : none
            newpage.page-break    : page
