...
=encoding UTF8
    ...
    // section {
    //     bridge {
    //         // all text/chord size/font/color are allowed.
    //         textsize: 120%
    //         textcolor: blue
    //         chordcolour: red
    //         // indent is a number, or otherwise the width of the string.
    //         indent: mm
    //         // Side bar, similar to chorus.
    //         bar {
    //             // Bar offset to the left of the text.
    //             // Suppresses bar when zero (default).
    //             offset : 5
    //             // Bar width. Suppress when zero (default).
    //             width :  3
    //             // Bar colour. Default is foreground colour.
    //             color :  lime
    //        }
    //     }
    // }
    ...
    // Config settings for delegates can depend on the backend that is used to produce the output. See the ABC settings for examples.
    ...
    delegates {
        ...
        abc {
            ...
            // The result produced by the delegate handler. Default is to ignore this section. HTML and PDF can handle SVG images.
    	pdf.type :  svg
    	html.type : svg
    
            // The name of the module that implements the delegate.
            module : ABC
    
            // The module's method to call.
            // Default handler uses `program` (if set), otherwise embedded QuickJS or external QuickJS.
            handler : abc2svg
    	...
    	// Specific ABC settings for the PDF backend. Append to generic.
            pdf.preamble : [
    	...
    	// Specific ABC settings for the HTML backends. Append to generic.
    	html.preamble : [
    	    "%%fullsvg 1"
    	]
        ...
        strum {
            ...
            // The result produced by the delegate handler. Default is to ignore this section. PDF can handle PDF (XO) images.
    	pdf.type :  pdf
        ...
        textblock {
            ...
            // The result produced by the delegate handler. Default is to ignore this section. HTML does native and PDF can handle SVG images.
    	pdf.type :  svg
    	html.type : html
