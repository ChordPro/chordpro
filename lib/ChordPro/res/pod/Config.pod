...
=encoding UTF8
    ...
    delegates {
      ...
      abc {
        ...
        // Obsolete. Please use parser.preprocess.env-abc instead.
        preprocess.abc : []
      }
    ...
    pdf {
      ...
      formats {
        ...
        // You can only set a background.
        filler {
    
          // Background page. Ignored if not found.
          background : ""
        }
      }
