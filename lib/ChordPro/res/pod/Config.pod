...
=encoding UTF8
    ...
    pdf {
    	...
    	// Bas style. Straight line or arc.
    	barstyle: line
        ...
        // With dual pages, align songs to right pages by inserting
        // a blank filler page. 
        // Note this only applies to songs. Other parts (covers,
        // tables of contents, etc.) are always aligned.
        pagealign-songs : true
    
        // With dual pages, start all songs on an even (left) page.
        pagealign-songs-spread : false
    
        // When songs need alignment, extend the song with a page (true) or
        // use a blank filler page (false).
        pagealign-songs-extend : false
    
        // How to reorder song pages.
        // Sort pages by "title", "subtitle", or "compact".
        // title  : sort pages alphabetically by title.
        // title,desc  : same, but descending order
        // subtitle : sort pages alphabetically by subtitle. If this is
        //          used together with title, only title is used.
        // subtitle,desc  : same, but descending order
        // compact: reorder to make the songbook as compact as possible, while
        //          each of the songs require minimal page turns.
    	...
    	// Font for numbered chord dots and other symbols.
    	chordfingers : "ChordProSymbols.ttf; numbercolor=background"
