...
=encoding UTF8
    ...
    pdf {
        ...
        // Dual (odd/even) pages when set to true (1).
        // False means all pages will be the same (odd)
        // A value of -1 will produce dual pages with the left/right
        // parts of headings/footers swapped.
        even-odd-pages : true
    
        // With dual pages, align songs to odd pages by inserting
        // a blank filler page. When greater than 1, a song page
        // (with headings/footers) is used to align.
        // Note this only applies to songs. Other parts (covers,
        // tables of conents, etc.) are always aligned.
        pagealign-songs : 1
        ...
        // Note this only applies to songs. Other parts (covers,
        // tables of conents, etc.) are not reordered.
        //
