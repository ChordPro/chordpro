# generated by wxGlade 1.1.0b1 on Sat Nov  2 14:55:57 2024
#
...
sub new {
    ...
    $self->{p_top} = Wx::Panel->new($self->{sw_tb}, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxBORDER_SIMPLE|wxTAB_TRAVERSAL);
    ...
    $self->{p_bottom} = Wx::Panel->new($self->{sw_tb}, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxBORDER_SIMPLE|wxTAB_TRAVERSAL);
    ...
    $self->{sw_lr}->SplitVertically($self->{p_left}, $self->{p_right}, , 252);
