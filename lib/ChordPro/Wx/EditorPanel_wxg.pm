# generated by wxGlade 1.1.0b1 on Sat Nov  2 16:11:19 2024
#
...
sub new {
    ...
    $self->{sz_toolbar}->Add($self->{bmp_songbook}, 0, wxEXPAND|wxRIGHT, 5);
    ...
    $self->{sw_lr}->SplitVertically($self->{p_left}, $self->{p_right}, , 458);
