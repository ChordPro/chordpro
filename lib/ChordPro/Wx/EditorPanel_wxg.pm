# generated by wxGlade 1.1.0b1 on Sat Nov  2 22:27:52 2024
#
...
sub new {
    ...
    $self->{bmp_songbook}->SetBitmap(Wx::ArtProvider::GetBitmap(wxART_GO_BACK, wxART_TOOLBAR, wxDefaultSize), wxTOP);
    ...
    $self->{sz_toolbar}->Add($self->{bmp_preferences}, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);
    ...
    $self->{sz_toolbar}->Add($self->{bmb_messages}, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);
    ...
    $self->{t_messages}->SetFont(Wx::Font->new(12, wxFONTFAMILY_MODERN, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, 0, ""));
    ...
    $self->{sw_lr}->SplitVertically($self->{p_left}, $self->{p_right}, , 337);
