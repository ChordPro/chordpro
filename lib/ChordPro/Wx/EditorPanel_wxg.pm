# generated by wxGlade 1.1.0b1 on Thu Oct 17 20:42:50 2024
#
...
sub new {
    ...
    $self->{sz_outer}->Add($self->{sz_toolbar}, 0, wxEXPAND, 0);
    ...
    $self->{bmb_preview}->SetToolTip(_T("Preview"));
    ...
    $self->{sw_ep_m} = Wx::SplitterWindow->new($self, wxID_ANY);
    $self->{sw_ep_m}->SetMinimumPaneSize(20);
    $self->{sz_outer}->Add($self->{sw_ep_m}, 1, wxEXPAND, 0);
    
    $self->{p_top} = Wx::Panel->new($self->{sw_ep_m}, wxID_ANY);
    
    $self->{sz_ep} = Wx::BoxSizer->new(wxVERTICAL);
    
    $self->{sw_e_p} = Wx::SplitterWindow->new($self->{p_top}, wxID_ANY);
    $self->{sw_e_p}->SetMinimumPaneSize(20);
    $self->{sw_e_p}->SetSashGravity(0.5);
    $self->{sz_ep}->Add($self->{sw_e_p}, 1, wxEXPAND, 0);
    
    $self->{p_left} = Wx::Panel->new($self->{sw_e_p}, wxID_ANY);
    
    $self->{sz_editor} = Wx::BoxSizer->new(wxVERTICAL);
    
    $self->{t_editor} = Wx::TextCtrl->new($self->{p_left}, wxID_ANY, "", wxDefaultPosition, wxDefaultSize, wxTE_MULTILINE);
    $self->{t_editor}->SetFocus();
    $self->{sz_editor}->Add($self->{t_editor}, 1, wxEXPAND, 0);
    
    $self->{p_right} = Wx::Panel->new($self->{sw_e_p}, wxID_ANY);
    ...
    $self->{p_bottom} = Wx::Panel->new($self->{sw_ep_m}, wxID_ANY);
    ...
    $self->{sw_e_p}->SplitVertically($self->{p_left}, $self->{p_right}, , 186);
    
    $self->{p_top}->SetSizer($self->{sz_ep});
    
    $self->{sw_ep_m}->SplitHorizontally($self->{p_top}, $self->{p_bottom}, );
    ...
    Wx::Event::EVT_SPLITTER_SASH_POS_CHANGED($self, $self->{sw_ep_m}->GetId, $self->can('OnSashTBChanged'));
    Wx::Event::EVT_SPLITTER_SASH_POS_CHANGED($self, $self->{sw_e_p}->GetId, $self->can('OnSashLRChanged'));
