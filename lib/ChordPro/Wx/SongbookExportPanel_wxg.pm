# generated by wxGlade 1.1.0b1 on Mon Oct 21 13:29:43 2024
#
...
sub new {
    ...
    $self->{sz_ep}->Add($self->{sw_e_p}, 0, wxEXPAND, 0);
    ...
    $self->{sw_e_p}->SplitVertically($self->{p_left}, $self->{p_right}, , 575);
