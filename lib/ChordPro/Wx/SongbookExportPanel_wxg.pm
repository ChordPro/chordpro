# generated by wxGlade 1.1.0b1 on Sat Sep 14 22:33:42 2024
#
...
sub new {
    ...
    $self->SetSize(Wx::Size->new(624, 624));
    ...
    my $label_5 = Wx::StaticText->new($self->{sz_export_outer}->GetStaticBox(), wxID_ANY, _T("Subtitle"));
    $self->{sz_sbexp}->Add($label_5, 0, wxALIGN_CENTER_VERTICAL, 5);
