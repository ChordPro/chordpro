# generated by wxGlade 1.1.0b1 on Sat Nov  2 15:21:29 2024
#
...
sub new {
    ...
    $self->{b_deselectall} = Wx::Button->new($self->{p_left}, wxID_ANY, _T("Deselect All"));
    ...
    $self->{sw_lr}->SplitVertically($self->{p_left}, $self->{p_right}, , 595);
