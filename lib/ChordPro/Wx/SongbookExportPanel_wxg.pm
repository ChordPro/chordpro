# generated by wxGlade 1.1.0b1 on Tue Sep 17 15:03:49 2024
#
...
sub new {
    ...
    $self->SetSize(Wx::Size->new(628, 628));
    ...
    $self->{sx_export_inner} = Wx::BoxSizer->new(wxVERTICAL);
    $self->{sizer_1}->Add($self->{sx_export_inner}, 1, wxEXPAND, 0);
    
    $self->{sz_sbexp} = Wx::FlexGridSizer->new(8, 2, 5, 5);
    $self->{sx_export_inner}->Add($self->{sz_sbexp}, 0, wxEXPAND, 5);
