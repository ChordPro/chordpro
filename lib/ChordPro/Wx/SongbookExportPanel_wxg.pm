# generated by wxGlade 1.1.0b1 on Tue Sep 10 21:50:20 2024
#
...
sub OnCancel {
    my ($self, $event) = @_;
    # wxGlade: ChordPro::Wx::SongbookExportPanel_wxg::OnCancel <event_handler>
...
sub OnAccept {
    my ($self, $event) = @_;
    # wxGlade: ChordPro::Wx::SongbookExportPanel_wxg::OnAccept <event_handler>
