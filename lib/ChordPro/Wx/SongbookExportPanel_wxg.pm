# generated by wxGlade 1.1.0b1 on Tue Oct 15 21:53:53 2024
#
...
sub new {
    ...
    $self->SetSize(Wx::Size->new(562, 1054));
    ...
    $self->{sz_export_inner}->Add($self->{sizer_1}, 0, wxEXPAND, 0);
    
    my $label_2 = Wx::StaticText->new($self->{p_left}, wxID_ANY, _T("Songbook"));
    ...
    my $label_4 = Wx::StaticText->new($self->{p_preview}, wxID_ANY, _T("Preview"));
    $self->{sizer_3}->Add($label_4, 0, wxALIGN_CENTER_VERTICAL, 0);
    ...
    $self->{bmb_preview_save}->SetToolTip(_T("Save PDF"));
    ...
    $self->{bmb_preview_close}->SetToolTip(_T("Close preview"));
