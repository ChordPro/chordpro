# generated by wxGlade 1.1.0b1 on Thu Oct 31 21:48:18 2024
#
...
sub new {
    ...
    $self->{cb_filelist} = Wx::CheckBox->new($self->{p_left}, wxID_ANY, _T("Use filelist.txt"));
    ...
    $self->{b_selectall} = Wx::Button->new($self->{p_left}, wxID_SELECTALL, "");
    $self->{sz_rearrangebuttons}->Add($self->{b_selectall}, 0, wxBOTTOM|wxEXPAND|wxLEFT, 5);
    
    $self->{b_deselectall} = Wx::Button->new($self->{p_left}, wxID_CLEAR, "");
    ...
    $self->{sw_lr}->SplitVertically($self->{p_left}, $self->{p_right}, , 600);
