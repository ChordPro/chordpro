# generated by wxGlade 1.1.0b1 on Sat Nov  2 15:34:06 2024
#
...
sub new {
    ...
    $self->{cb_recursive} = Wx::CheckBox->new($self->{p_left}, wxID_ANY, _T("Subfolders"));
    ...
    $self->{sw_lr}->SplitVertically($self->{p_left}, $self->{p_right}, , 598);
