# generated by wxGlade 1.1.0b1 on Thu Sep 19 21:21:39 2024
#
...
sub new {
    ...
    $self->{sizer_8}->Add($bm_init, 1, 0, 0);
    ...
    $self->{sizer_2}->Add($self->{l_init}, 0, wxBOTTOM|wxFIXED_MINSIZE|wxTOP, 40);
    
    $self->{sizer_2}->Add(1, 1, 2, wxEXPAND, 0);
