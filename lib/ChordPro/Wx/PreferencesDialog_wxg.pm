# generated by wxGlade 1.1.0b1 on Wed Nov  6 10:24:08 2024
#
...
sub new {
    ...
    $self->{sz_prefs_inner}->Add($self->{sz_prefs}, 1, wxEXPAND|wxTOP, 5);
    ...
    $self->{sz_prefs}->Add($self->{ch_presets}, Wx::GBPosition->new(1, 1), Wx::GBSpan->new(1, 1), wxEXPAND, 5);
    ...
    $self->{sz_prefs}->Add($self->{fp_customconfig}, Wx::GBPosition->new(2, 1), Wx::GBSpan->new(1, 1), wxEXPAND, 5);
    ...
    $self->{dp_customlibrary}->SetToolTipString(_T("Select the custom library folder"));
    $self->{sz_prefs}->Add($self->{dp_customlibrary}, Wx::GBPosition->new(3, 1), Wx::GBSpan->new(1, 1), wxEXPAND, 5);
    ...
    $self->{fp_tmplfile}->SetToolTipString(_T("Select the template song for new songs"));
    $self->{sz_prefs}->Add($self->{fp_tmplfile}, Wx::GBPosition->new(4, 1), Wx::GBSpan->new(1, 1), wxEXPAND, 5);
    ...
    $self->{sz_prefs}->Add($self->{l_editor}, Wx::GBPosition->new(12, 0), Wx::GBSpan->new(1, 1), wxALIGN_CENTER_VERTICAL, 5);
    
    $self->{sz_editor} = Wx::BoxSizer->new(wxHORIZONTAL);
    $self->{sz_prefs}->Add($self->{sz_editor}, Wx::GBPosition->new(12, 1), Wx::GBSpan->new(1, 1), wxEXPAND, 0);
    ...
    $self->{sz_editor}->Add($self->{fp_editor}, 1, wxEXPAND|wxLEFT, 5);
    ...
    $self->{sz_prefs}->Add($self->{sl_editor}, Wx::GBPosition->new(13, 0), Wx::GBSpan->new(1, 2), wxEXPAND, 0);
    
    $self->{l_messages} = Wx::StaticText->new($self, wxID_ANY, _T("Messages"));
    $self->{sz_prefs}->Add($self->{l_messages}, Wx::GBPosition->new(14, 0), Wx::GBSpan->new(1, 1), wxALIGN_CENTER_VERTICAL, 5);
    
    $self->{sz_messages} = Wx::BoxSizer->new(wxHORIZONTAL);
    $self->{sz_prefs}->Add($self->{sz_messages}, Wx::GBPosition->new(14, 1), Wx::GBSpan->new(1, 1), wxEXPAND, 0);
    ...
    $self->{sz_messages}->Add($self->{fp_messages}, 1, wxEXPAND|wxLEFT, 5);
    
    my $sl_messages = Wx::StaticLine->new($self, wxID_ANY);
    $self->{sz_prefs}->Add($sl_messages, Wx::GBPosition->new(15, 0), Wx::GBSpan->new(1, 2), wxEXPAND, 0);
...
sub OnCustomLibChanged {
    my ($self, $event) = @_;
    # wxGlade: ChordPro::Wx::PreferencesDialog_wxg::OnCustomLibChanged <event_handler>
