# generated by wxGlade 1.1.0b1 on Thu Nov  7 19:40:35 2024
#
...
sub new {
    ...
    Wx::Event::EVT_FILEPICKER_CHANGED($self, $self->{fp_tmplfile}->GetId, $self->can('OnTmplFileChanged'));
...
sub OnTmplFileChanged {
    my ($self, $event) = @_;
    # wxGlade: ChordPro::Wx::PreferencesDialog_wxg::OnTmplFileChanged <event_handler>
    warn "Event handler (OnTmplFileChanged) not implemented";
    $event->Skip;
    # end wxGlade
}
