# generated by wxGlade 1.1.0a2 on Mon Jun 24 16:36:07 2024
#
...
sub new {
    ...
    $self->{sz_prefs_inner}->Add($self->{sz_prefs}, 1, wxEXPAND, 5);
    ...
    $self->{sz_prefs}->Add($self->{cb_skipstdcfg}, Wx::GBPosition->new(0, 0), Wx::GBSpan->new(1, 2), wxALIGN_CENTER_VERTICAL|wxEXPAND|wxLEFT|wxRIGHT, 5);
    
    $self->{cb_pkgfonts} = Wx::CheckBox->new($self, wxID_ANY, _T("Use packaged fonts"));
    $self->{cb_pkgfonts}->SetToolTipString(_T("Use a pre-packaged set of fonts that support most languages"));
    $self->{sz_prefs}->Add($self->{cb_pkgfonts}, Wx::GBPosition->new(1, 0), Wx::GBSpan->new(1, 2), wxALIGN_CENTER_VERTICAL|wxEXPAND|wxLEFT|wxRIGHT, 5);
    
    $self->{cb_presets} = Wx::CheckBox->new($self, wxID_ANY, _T("Presets"));
    $self->{cb_presets}->SetToolTipString(_T("Select this to use one or more of the presets provided with ChordPro. Choose the presets from the dropdown list."));
    $self->{sz_prefs}->Add($self->{cb_presets}, Wx::GBPosition->new(2, 0), Wx::GBSpan->new(1, 1), wxLEFT|wxTOP, 5);
    ...
    $self->{sz_prefs}->Add($self->{ch_presets}, Wx::GBPosition->new(2, 1), Wx::GBSpan->new(1, 1), wxALIGN_CENTER_VERTICAL|wxEXPAND|wxRIGHT|wxTOP, 5);
    
    $self->{cb_configfile} = Wx::CheckBox->new($self, wxID_ANY, _T("Custom config"));
    $self->{cb_configfile}->SetToolTipString(_T("Select a custom config file by pressing the [...] button."));
    $self->{sz_prefs}->Add($self->{cb_configfile}, Wx::GBPosition->new(3, 0), Wx::GBSpan->new(1, 1), wxALIGN_CENTER_VERTICAL|wxLEFT, 5);
    
    $self->{sz_configfile} = Wx::BoxSizer->new(wxHORIZONTAL);
    $self->{sz_prefs}->Add($self->{sz_configfile}, Wx::GBPosition->new(3, 1), Wx::GBSpan->new(1, 1), wxEXPAND|wxRIGHT, 5);
    ...
    $self->{cb_customlib} = Wx::CheckBox->new($self, wxID_ANY, _T("Custom resources"));
    $self->{cb_customlib}->SetToolTipString(_T("Select a custom resource library by pressing the [...] button."));
    $self->{sz_prefs}->Add($self->{cb_customlib}, Wx::GBPosition->new(4, 0), Wx::GBSpan->new(1, 1), wxALIGN_CENTER_VERTICAL|wxLEFT, 5);
    
    $self->{sz_customlib} = Wx::BoxSizer->new(wxHORIZONTAL);
    $self->{sz_prefs}->Add($self->{sz_customlib}, Wx::GBPosition->new(4, 1), Wx::GBSpan->new(1, 1), wxEXPAND|wxRIGHT, 5);
    
    $self->{t_customlibdialog} = Wx::TextCtrl->new($self, wxID_ANY, "", wxDefaultPosition, wxDefaultSize, $^O =~ /darwin/ ? 0 : wxTE_READONLY);
    $self->{t_customlibdialog}->SetToolTipString(_T("Select a custom resource library by pressing the [...] button."));
    ...
    $self->{cb_tmplfile}->SetToolTipString(_T("A boiler plate to use for creating new songs."));
    $self->{sz_prefs}->Add($self->{cb_tmplfile}, Wx::GBPosition->new(5, 0), Wx::GBSpan->new(1, 1), wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, 5);
    
    $self->{sz_tmplfile} = Wx::BoxSizer->new(wxHORIZONTAL);
    $self->{sz_prefs}->Add($self->{sz_tmplfile}, Wx::GBPosition->new(5, 1), Wx::GBSpan->new(1, 1), wxEXPAND|wxRIGHT, 5);
    ...
    $self->{sz_prefs}->Add($static_line_5, Wx::GBPosition->new(6, 0), Wx::GBSpan->new(1, 2), wxEXPAND, 0);
    
    $self->{l_notation} = Wx::StaticText->new($self, wxID_ANY, _T("Notation"));
    $self->{l_notation}->SetToolTipString(_T("Select the notation system for the song"));
    $self->{sz_prefs}->Add($self->{l_notation}, Wx::GBPosition->new(7, 0), Wx::GBSpan->new(1, 1), wxALIGN_CENTER_VERTICAL|wxLEFT, 5);
    ...
    $self->{sz_prefs}->Add($self->{ch_notation}, Wx::GBPosition->new(7, 1), Wx::GBSpan->new(1, 1), wxALIGN_CENTER_VERTICAL|wxEXPAND|wxRIGHT, 5);
    
    $self->{l_xpose} = Wx::StaticText->new($self, wxID_ANY, _T("Transpose"));
    $self->{sz_prefs}->Add($self->{l_xpose}, Wx::GBPosition->new(8, 0), Wx::GBSpan->new(1, 1), wxALIGN_CENTER_VERTICAL|wxLEFT, 5);
    
    $self->{sz_xpose} = Wx::BoxSizer->new(wxHORIZONTAL);
    $self->{sz_prefs}->Add($self->{sz_xpose}, Wx::GBPosition->new(8, 1), Wx::GBSpan->new(1, 1), wxEXPAND|wxRIGHT, 5);
    ...
    $self->{l_transcode}->SetToolTipString(_T("Select the notation system to transcode the song into."));
    $self->{sz_prefs}->Add($self->{l_transcode}, Wx::GBPosition->new(9, 0), Wx::GBSpan->new(1, 1), wxALIGN_CENTER_VERTICAL|wxLEFT, 5);
    ...
    $self->{sz_prefs}->Add($self->{ch_transcode}, Wx::GBPosition->new(9, 1), Wx::GBSpan->new(1, 1), wxALIGN_CENTER_VERTICAL|wxEXPAND|wxRIGHT, 5);
    
    my $static_line_3 = Wx::StaticLine->new($self, wxID_ANY);
    $self->{sz_prefs}->Add($static_line_3, Wx::GBPosition->new(10, 0), Wx::GBSpan->new(1, 2), wxEXPAND, 0);
    
    my $l_edit = Wx::StaticText->new($self, wxID_ANY, _T("Editor font"));
    $l_edit->SetToolTipString(_T("Font to use in the editor. Usually \N{U+2018}Monospaced\N{U+2019} is the best choice."));
    $self->{sz_prefs}->Add($l_edit, Wx::GBPosition->new(11, 0), Wx::GBSpan->new(1, 1), wxALIGN_CENTER_VERTICAL|wxLEFT, 5);
    
    $self->{sizer_3} = Wx::BoxSizer->new(wxHORIZONTAL);
    $self->{sz_prefs}->Add($self->{sizer_3}, Wx::GBPosition->new(11, 1), Wx::GBSpan->new(1, 1), wxEXPAND, 0);
    ...
    $self->{l_pdfviewer}->SetToolTipString(_T("Specify a PDF previewer, or leave empty to use the system default viewer"));
    $self->{sz_prefs}->Add($self->{l_pdfviewer}, Wx::GBPosition->new(12, 0), Wx::GBSpan->new(1, 1), wxALIGN_CENTER_VERTICAL|wxLEFT, 5);
    ...
    $self->{sz_prefs}->Add($self->{t_pdfviewer}, Wx::GBPosition->new(12, 1), Wx::GBSpan->new(1, 1), wxEXPAND|wxRIGHT, 5);
    ...
    $self->{sz_prefs}->AddGrowableRow(2);
    ...
    Wx::Event::EVT_CHECKBOX($self, $self->{cb_pkgfonts}->GetId, $self->can('OnUsePkgFonts'));
...
sub OnUsePkgFonts {
    my ($self, $event) = @_;
    # wxGlade: ChordPro::Wx::PreferencesDialog_wxg::OnUsePkgFonts <event_handler>
    warn "Event handler (OnUsePkgFonts) not implemented";
    $event->Skip;
    # end wxGlade
}
...
sub OnConfigFileDialog {
    my ($self, $event) = @_;
    # wxGlade: ChordPro::Wx::PreferencesDialog_wxg::OnConfigFileDialog <event_handler>
...
sub OnCustomLibDialog {
    my ($self, $event) = @_;
    # wxGlade: ChordPro::Wx::PreferencesDialog_wxg::OnCustomLibDialog <event_handler>
...
sub OnTmplFileDialog {
    my ($self, $event) = @_;
    # wxGlade: ChordPro::Wx::PreferencesDialog_wxg::OnTmplFileDialog <event_handler>
