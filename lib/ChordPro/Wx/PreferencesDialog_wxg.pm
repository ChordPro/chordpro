# generated by wxGlade 1.1.0b1 on Mon Nov 11 13:40:51 2024
#
...
sub new {
    ...
    use ChordPro::Wx::Utils qw(wxRESERVE_SPACE_EVEN_IF_HIDDEN);
    ...
    $self->{l_editor_1} = Wx::StaticText->new($self, wxID_ANY, _T("Editor"));
    $self->{sz_prefs}->Add($self->{l_editor_1}, Wx::GBPosition->new(14, 0), Wx::GBSpan->new(1, 1), wxALIGN_CENTER_VERTICAL, 5);
    
    $self->{sz_editor_1} = Wx::BoxSizer->new(wxHORIZONTAL);
    $self->{sz_prefs}->Add($self->{sz_editor_1}, Wx::GBPosition->new(14, 1), Wx::GBSpan->new(1, 1), wxEXPAND, 0);
    ...
    $self->{sz_editor_1}->Add($self->{fp_editor}, 1, wxEXPAND, 5);
    ...
    $self->{sz_editor_1}->Add($self->{cp_editor}, 0, wxEXPAND|wxLEFT, 5);
    
    $self->{l_editor_2} = Wx::StaticText->new($self, wxID_ANY, "");
    $self->{sz_prefs}->Add($self->{l_editor_2}, Wx::GBPosition->new(15, 0), Wx::GBSpan->new(1, 1), wxALIGN_CENTER_VERTICAL|wxEXPAND, 0);
    
    $self->{sz_editor_2} = Wx::BoxSizer->new(wxHORIZONTAL);
    $self->{sz_prefs}->Add($self->{sz_editor_2}, Wx::GBPosition->new(15, 1), Wx::GBSpan->new(1, 1), wxEXPAND, 0);
    
    $self->{cb_editorwrap} = Wx::CheckBox->new($self, wxID_ANY, _T("Wrap"), wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT);
    $self->{sz_editor_2}->Add($self->{cb_editorwrap}, 0, wxALIGN_CENTER_VERTICAL, 0);
    
    $self->{l_editorwrap} = Wx::StaticText->new($self, wxID_ANY, _T("Indent"));
    $self->{sz_editor_2}->Add($self->{l_editorwrap}, 0, wxALIGN_CENTER_VERTICAL|wxRIGHT, 5);
    
    $self->{sp_editorwrap} = Wx::SpinCtrl->new($self, wxID_ANY, "0", wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 16, 0);
    $self->{sp_editorwrap}->SetToolTipString(_T("The amount of indentation for wrapped lines"));
    $self->{sz_editor_2}->Add($self->{sp_editorwrap}, 0, wxEXPAND, 0);
    
    $self->{sz_editor_2}->Add(20, 20, 1, wxEXPAND, 0);
    
    $self->{b_editorcolours} = Wx::Button->new($self, wxID_ANY, _T("Colours"));
    $self->{b_editorcolours}->SetToolTipString(_T("Specify the colours used for syntax highlighting."));
    $self->{sz_editor_2}->Add($self->{b_editorcolours}, 0, wxALIGN_CENTER_VERTICAL, 0);
    
    $self->{sl_editor} = Wx::StaticLine->new($self, wxID_ANY);
    $self->{sz_prefs}->Add($self->{sl_editor}, Wx::GBPosition->new(16, 0), Wx::GBSpan->new(1, 2), wxEXPAND, 0);
    ...
    $self->{sz_prefs_buttons}->Add($self->{b_prefs_cancel}, 0, wxALIGN_CENTER_VERTICAL, 0);
    ...
    $self->{sz_prefs_buttons}->Add($self->{b_prefs_ok}, 0, wxALIGN_CENTER_VERTICAL|wxLEFT, 5);
    ...
    Wx::Event::EVT_BUTTON($self, $self->{b_editorcolours}->GetId, $self->can('OnEditorColours'));
...
sub OnEditorWrap {
    my ($self, $event) = @_;
    # wxGlade: ChordPro::Wx::PreferencesDialog_wxg::OnEditorWrap <event_handler>
...
sub OnEditorColours {
    my ($self, $event) = @_;
    # wxGlade: ChordPro::Wx::PreferencesDialog_wxg::OnEditorColours <event_handler>
    warn "Event handler (OnEditorColours) not implemented";
    $event->Skip;
    # end wxGlade
}
