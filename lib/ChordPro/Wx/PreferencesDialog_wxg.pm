# generated by wxGlade 1.1.0b1 on Tue Nov 12 10:57:19 2024
#
...
sub new {
    ...
    $self->{sp_editorwrap} = Wx::SpinCtrl->new($self, wxID_ANY, "0", wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 15, 0);
