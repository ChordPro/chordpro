# generated by wxGlade 1.1.0b1 on Thu Oct 31 13:05:42 2024
#
...
sub new {
    ...
    $self->{sz_prefs}->Add($l_edit, Wx::GBPosition->new(10, 0), Wx::GBSpan->new(1, 1), wxALIGN_CENTER_VERTICAL, 5);
    
    $self->{sz_edit} = Wx::BoxSizer->new(wxHORIZONTAL);
    $self->{sz_prefs}->Add($self->{sz_edit}, Wx::GBPosition->new(10, 1), Wx::GBSpan->new(1, 1), wxEXPAND, 0);
    ...
    $self->{sz_edit}->Add($self->{ch_editfont}, 1, wxEXPAND, 0);
    ...
    $self->{sz_edit}->Add($self->{sp_editfont}, 0, wxALIGN_CENTER_VERTICAL|wxLEFT, 5);
    ...
    $self->{sz_edit}->Add($self->{cp_editor}, 0, wxEXPAND|wxLEFT, 5);
    ...
    $self->{sz_prefs}->Add($self->{cb_pdfviewer}, Wx::GBPosition->new(11, 0), Wx::GBSpan->new(1, 1), 0, 0);
    ...
    $self->{sz_prefs}->Add($self->{t_pdfviewer}, Wx::GBPosition->new(11, 1), Wx::GBSpan->new(1, 1), wxEXPAND, 5);
