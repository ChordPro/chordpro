# generated by wxGlade 1.1.0 on Fri Nov 22 10:25:32 2024
#
...
sub new {
    ...
    my $label_3 = Wx::StaticText->new($self, wxID_ANY, _T("Preview Tasks"));
    ...
    $self->{sz_prefs_outer}->Add($self->{sz_prefs_inner}, 1, wxEXPAND|wxLEFT|wxRIGHT|wxTOP, 5);
    ...
    $self->{sz_tasks_buttons}->Add($self->{b_ok}, 0, wxLEFT|wxRIGHT, 5);
