# generated by wxGlade 1.1.1 on Sun Nov 23 10:18:46 2025
#
...
sub new {
    ...
    $self->{ch_acc} = Wx::Choice->new($self, wxID_ANY, wxDefaultPosition, wxDefaultSize, [_T("Sharps when transposing up, flats when down"), _T("Always use sharps"), _T("Always use flats")], );
