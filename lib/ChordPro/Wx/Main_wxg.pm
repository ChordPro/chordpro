# generated by wxGlade 1.1.0b1 on Thu Sep  5 21:54:16 2024
#
...
sub new {
    ...
    use constant wxID_W_EDITOR => Wx::NewId();
    ...
    $wxglade_tmp_menu->AppendSeparator();
    $wxglade_tmp_menu->Append(wxID_W_EDITOR, _T("Show editor window"), _T("Show the editor window"), 2);
    $wxglade_tmp_menu->Append(wxID_W_MSG, _T("Show Messages window"), _T("Show the messages window."), 2);
    ...
    $self->{sz_msg} = Wx::StaticBoxSizer->new(Wx::StaticBox->new($self->{p_msg}, wxID_ANY, _T("Messages")), wxHORIZONTAL);
    ...
    Wx::Event::EVT_MENU($self, wxID_W_EDITOR, $self->can('OnHelp_ShowEditor'));
...
sub OnHelp_ShowEditor {
    my ($self, $event) = @_;
    # wxGlade: ChordPro::Wx::Main_wxg::OnHelp_ShowEditor <event_handler>
    warn "Event handler (OnHelp_ShowEditor) not implemented";
    $event->Skip;
    # end wxGlade
}
