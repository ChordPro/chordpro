# generated by wxGlade 1.1.0b1 on Wed Oct 23 10:36:54 2024
#
...
sub new {
    ...
    $self->SetSize($self->ConvertDialogSizeToPixels(Wx::Size->new(490, 258)));
    ...
    $self->{sz_init}->Add($self->{sizer_13}, 2, wxEXPAND, 0);
    ...
    $self->{sizer_8}->Add(1, 1, 3, wxEXPAND, 0);
    ...
    $self->{sizer_8}->Add(1, 1, 17, wxEXPAND, 0);
    
    $self->{sizer_2} = Wx::BoxSizer->new(wxVERTICAL);
    $self->{sizer_14}->Add($self->{sizer_2}, 2, wxEXPAND|wxLEFT, 20);
    ...
    my $static_line_2 = Wx::StaticLine->new($self->{p_initial}, wxID_ANY);
    $self->{sizer_2}->Add($static_line_2, 0, wxEXPAND, 0);
    
    $self->{sizer_2}->Add(1, 10, 0, wxEXPAND, 0);
    
    $self->{pn_exit} = Wx::Panel->new($self->{p_initial}, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxBORDER_THEME);
    $self->{pn_exit}->SetBackgroundColour(Wx::Colour->new(243, 243, 243));
    $self->{pn_exit}->SetToolTip(_T("Exit"));
    $self->{sizer_2}->Add($self->{pn_exit}, 0, wxEXPAND, 0);
    
    $self->{sizer_12} = Wx::BoxSizer->new(wxHORIZONTAL);
    
    my $bitmap_7 = Wx::StaticBitmap->new($self->{pn_exit}, wxID_ANY, Wx::Bitmap->new("/usr/local/src/ChordPro/lib/ChordPro/res/icons/exit32.png", wxBITMAP_TYPE_ANY));
    $self->{sizer_12}->Add($bitmap_7, 0, wxALL, 10);
    
    my $label_7 = Wx::StaticText->new($self->{pn_exit}, wxID_ANY, _T("Exit"));
    $self->{sizer_12}->Add($label_7, 0, wxALIGN_CENTER_VERTICAL, 0);
    ...
    $self->{pn_exit}->SetSizer($self->{sizer_12});
