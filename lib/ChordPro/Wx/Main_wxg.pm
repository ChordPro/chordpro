# generated by wxGlade 1.1.0b1 on Fri Oct 18 22:34:04 2024
#
...
sub new {
    ...
    $self->{sz_init}->Add($self->{sizer_13}, 1, wxEXPAND, 0);
    ...
    $self->{sizer_14}->Add($self->{sizer_2}, 0, wxEXPAND|wxLEFT, 20);
    ...
    $self->{b_initwww} = Wx::Button->new($self->{p_initial}, wxID_ANY, "");
    ...
    $self->{l_initwww} = Wx::StaticText->new($self->{p_initial}, wxID_ANY, _T("Visit the ChordPro site"));
    ...
    $self->{b_initdocs} = Wx::Button->new($self->{p_initial}, wxID_ANY, "");
    ...
    $self->{l_initdocs} = Wx::StaticText->new($self->{p_initial}, wxID_ANY, _T("Read the documentation"));
    ...
    $self->{b_exit} = Wx::Button->new($self->{p_initial}, wxID_ANY, "");
    ...
    $self->{l_exit} = Wx::StaticText->new($self->{p_initial}, wxID_ANY, _T("Exit"));
