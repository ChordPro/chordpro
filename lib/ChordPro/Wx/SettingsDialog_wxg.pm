# generated by wxGlade 1.1.1 on Tue Apr  1 19:21:24 2025
#
...
sub new {
    ...
    $self->{ch_extra2}->SetMaxSize($self->{ch_extra2}->ConvertDialogSizeToPixels(Wx::Size->new(-1, 55)));
    ...
    $self->{sz_presets}->AddGrowableCol(2);
