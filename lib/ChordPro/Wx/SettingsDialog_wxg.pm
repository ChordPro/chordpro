# generated by wxGlade 1.1.1 on Sat Mar 22 15:53:27 2025
#
...
sub new {
    ...
    $self->{sizer_9} = Wx::FlexGridSizer->new(4, 2, 15, 15);
    ...
    $self->{l_prefext} = Wx::StaticText->new($self->{nb_config}, wxID_ANY, _T("Preferred Filename Extension"));
    $self->{sizer_9}->Add($self->{l_prefext}, 0, wxALIGN_CENTER_VERTICAL, 0);
    
    $self->{t_prefext} = Wx::TextCtrl->new($self->{nb_config}, wxID_ANY, "");
    ...
    $self->{sizer_9}->Add($self->{t_prefext}, 0, wxEXPAND, 0);
    ...
    my $label_2 = Wx::StaticText->new($self->{nb_editor}, wxID_ANY, _T("Line numbers are automatically shown when the messages panel is visible."));
    ...
    $self->{sizer_10}->Add($self->{cb_tmplfile}, Wx::GBPosition->new(3, 0), Wx::GBSpan->new(1, 1), wxALIGN_CENTER_VERTICAL|wxEXPAND, 5);
    ...
    $self->{sizer_10}->Add($self->{fp_tmplfile}, Wx::GBPosition->new(3, 1), Wx::GBSpan->new(1, 1), wxEXPAND, 0);
    
    $self->{sz_editor} = Wx::BoxSizer->new(wxHORIZONTAL);
    $self->{sizer_10}->Add($self->{sz_editor}, Wx::GBPosition->new(4, 0), Wx::GBSpan->new(1, 2), wxEXPAND|wxTOP, 5);
