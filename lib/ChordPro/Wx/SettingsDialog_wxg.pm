# generated by wxGlade 1.1.1 on Sun May 10 19:35:25 2026
#
...
sub new {
    ...
    $self->{nb_previewer} = Wx::Notebook->new($self->{nb_preview}, wxID_ANY);
    $self->{sizer_3}->Add($self->{nb_previewer}, 1, wxEXPAND, 0);
    
    $self->{nb_preview_pdf} = Wx::Panel->new($self->{nb_previewer}, wxID_ANY);
    $self->{nb_previewer}->AddPage($self->{nb_preview_pdf}, _T("PDF Preview"));
    
    $self->{sizer_12} = Wx::GridBagSizer->new(15, 15);
    
    $self->{rb_preview_pdf} = Wx::RadioButton->new($self->{nb_preview_pdf}, wxID_ANY, _T("Preview PDF"), wxDefaultPosition, wxDefaultSize, wxRB_SINGLE);
    $self->{rb_preview_pdf}->SetMinSize(Wx::Size->new(130, -1));
    $self->{rb_preview_pdf}->SetValue(1);
    $self->{sizer_12}->Add($self->{rb_preview_pdf}, Wx::GBPosition->new(0, 0), Wx::GBSpan->new(1, 1), wxALIGN_CENTER_VERTICAL|wxLEFT|wxTOP, 5);
    
    $self->{cb_live_preview_pdf} = Wx::CheckBox->new($self->{nb_preview_pdf}, wxID_ANY, _T("Live preview (experimental)"));
    $self->{sizer_12}->Add($self->{cb_live_preview_pdf}, Wx::GBPosition->new(0, 1), Wx::GBSpan->new(1, 1), wxALIGN_CENTER_VERTICAL|wxTOP, 5);
    
    my $label_2 = Wx::StaticText->new($self->{nb_preview_pdf}, wxID_ANY, _T("By default ChordPro will use a built-in viewer to preview the generated PDF output.\n\nIn case you want a different viewer, check the checkbox and fill in the command required to run the alternative PDF viewer."));
    $label_2->Wrap(750);
    $self->{sizer_12}->Add($label_2, Wx::GBPosition->new(1, 0), Wx::GBSpan->new(1, 2), wxLEFT, 15);
    
    $self->{cb_pdfviewer} = Wx::CheckBox->new($self->{nb_preview_pdf}, wxID_ANY, _T("PDF Viewer"));
    $self->{cb_pdfviewer}->SetToolTip(_T("Use an external program instead of the built-in PDF viewer"));
    $self->{sizer_12}->Add($self->{cb_pdfviewer}, Wx::GBPosition->new(2, 0), Wx::GBSpan->new(1, 1), wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxLEFT, 15);
    
    $self->{t_pdfviewer} = Wx::TextCtrl->new($self->{nb_preview_pdf}, wxID_ANY, "");
    ...
    $self->{sizer_12}->Add($self->{t_pdfviewer}, Wx::GBPosition->new(2, 1), Wx::GBSpan->new(1, 1), wxEXPAND|wxRIGHT, 15);
    
    my $label_9 = Wx::StaticText->new($self->{nb_preview_pdf}, wxID_ANY, _T("In the command:\n    %f will be replaced by the file name of the PDF preview file\n    %u will be replaced by the URL of the PDF preview file\n"), wxDefaultPosition, wxDefaultSize, wxALIGN_LEFT);
    $label_9->Wrap(750);
    $self->{sizer_12}->Add($label_9, Wx::GBPosition->new(3, 0), Wx::GBSpan->new(1, 2), wxALL|wxEXPAND, 15);
    
    $self->{nb_preview_html} = Wx::Panel->new($self->{nb_previewer}, wxID_ANY);
    $self->{nb_previewer}->AddPage($self->{nb_preview_html}, _T("HTML Preview"));
    
    $self->{sizer_14} = Wx::GridBagSizer->new(15, 15);
    
    $self->{rb_preview_html} = Wx::RadioButton->new($self->{nb_preview_html}, wxID_ANY, _T("Preview HTML"), wxDefaultPosition, wxDefaultSize, wxRB_SINGLE);
    $self->{rb_preview_html}->SetMinSize(Wx::Size->new(130, -1));
    $self->{sizer_14}->Add($self->{rb_preview_html}, Wx::GBPosition->new(0, 0), Wx::GBSpan->new(1, 1), wxLEFT|wxTOP, 5);
    
    $self->{cb_live_preview_html} = Wx::CheckBox->new($self->{nb_preview_html}, wxID_ANY, _T("Live preview (experimental)"));
    $self->{sizer_14}->Add($self->{cb_live_preview_html}, Wx::GBPosition->new(0, 1), Wx::GBSpan->new(1, 1), wxTOP, 5);
    
    $self->{rb_html_previewer} = Wx::RadioBox->new($self->{nb_preview_html}, wxID_ANY, _T("Use"), wxDefaultPosition, wxDefaultSize, [_T("Classic HTML"), _T("Advanced HTML (experimental)")], 1, wxRA_SPECIFY_COLS);
    $self->{rb_html_previewer}->SetSelection(0);
    $self->{sizer_14}->Add($self->{rb_html_previewer}, Wx::GBPosition->new(1, 0), Wx::GBSpan->new(1, 2), wxALIGN_CENTER_VERTICAL|wxLEFT, 15);
    ...
    $self->{sizer_14}->AddGrowableCol(1);
    $self->{nb_preview_html}->SetSizer($self->{sizer_14});
    
    $self->{sizer_12}->AddGrowableCol(1);
    $self->{nb_preview_pdf}->SetSizer($self->{sizer_12});
    ...
    Wx::Event::EVT_RADIOBUTTON($self, $self->{rb_preview_pdf}->GetId, $self->can('OnRbPreviewPDF'));
    Wx::Event::EVT_CHECKBOX($self, $self->{cb_pdfviewer}->GetId, $self->can('OnPDFViewer'));
    Wx::Event::EVT_RADIOBUTTON($self, $self->{rb_preview_html}->GetId, $self->can('OnRbPreviewHTML'));
...
sub OnRbPreviewPDF {
    my ($self, $event) = @_;
    # wxGlade: ChordPro::Wx::SettingsDialog_wxg::OnRbPreviewPDF <event_handler>
    warn "Event handler (OnRbPreviewPDF) not implemented";
    $event->Skip;
    # end wxGlade
}
...
sub OnRbPreviewHTML {
    my ($self, $event) = @_;
    # wxGlade: ChordPro::Wx::SettingsDialog_wxg::OnRbPreviewHTML <event_handler>
    warn "Event handler (OnRbPreviewHTML) not implemented";
    $event->Skip;
    # end wxGlade
}
