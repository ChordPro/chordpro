# generated by wxGlade 1.1.1 on Mon May 11 19:38:02 2026
#
...
sub new {
    ...
    $self->{sizer_12}->Add($self->{rb_html_previewer}, Wx::GBPosition->new(5, 1), Wx::GBSpan->new(1, 1), wxALIGN_CENTER_VERTICAL, 40);
