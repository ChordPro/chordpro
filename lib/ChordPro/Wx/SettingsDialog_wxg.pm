# generated by wxGlade 1.1.0 on Wed Nov 27 15:23:12 2024
#
...
sub new {
    ...
    $self->{nb_preferences}->SetMaxSize(Wx::Size->new(-1, -1));
    ...
    $self->{sizer_1}->Add($label_1, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 15);
    ...
    $label_2->SetMinSize($label_2->ConvertDialogSizeToPixels(Wx::Size->new(195, 11)));
    $label_2->SetForegroundColour(Wx::Colour->new(0, 104, 217));
    $label_2->SetFont(Wx::Font->new(18, wxDEFAULT, wxNORMAL, wxNORMAL, 0, ""));
    $self->{sizer_8}->Add($label_2, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 15);
    
    $self->{sizer_7} = Wx::GridBagSizer->new(10, 5);
    ...
    $label_3->SetMinSize($label_3->ConvertDialogSizeToPixels(Wx::Size->new(79, 11)));
    $label_3->SetForegroundColour(Wx::Colour->new(0, 104, 217));
    $label_3->SetFont(Wx::Font->new(18, wxDEFAULT, wxNORMAL, wxNORMAL, 0, ""));
    $self->{sizer_5}->Add($label_3, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 15);
    ...
    $label_4->SetMinSize($label_4->ConvertDialogSizeToPixels(Wx::Size->new(101, 11)));
    $label_4->SetForegroundColour(Wx::Colour->new(0, 104, 217));
    $label_4->SetFont(Wx::Font->new(18, wxDEFAULT, wxNORMAL, wxNORMAL, 0, ""));
    $self->{sizer_4}->Add($label_4, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 15);
    ...
    $label_5->SetMinSize($label_5->ConvertDialogSizeToPixels(Wx::Size->new(89, 11)));
    $label_5->SetForegroundColour(Wx::Colour->new(0, 104, 217));
    $label_5->SetFont(Wx::Font->new(18, wxDEFAULT, wxNORMAL, wxNORMAL, 0, ""));
    $self->{sizer_3}->Add($label_5, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 15);
