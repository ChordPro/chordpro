# generated by wxGlade 1.1.1 on Wed Oct 15 15:01:45 2025
#
...
sub new {
    ...
    $self->{cb_skipstdcfg}->SetToolTip(_T("Ignore system, user and song configuration files, if any."));
    $self->{cb_skipstdcfg}->SetValue(1);
    $self->{sz_presets}->Add($self->{cb_skipstdcfg}, Wx::GBPosition->new(2, 0), Wx::GBSpan->new(1, 3), wxEXPAND|wxRIGHT, 5);
