# generated by wxGlade 1.1.0 on Fri Nov 22 10:25:54 2024
#
...
sub new {
    ...
    $self->{t_editor}->SetMaxSize(Wx::Size->new(-1, -1));
    $self->{sz_editor}->Add($self->{t_editor}, 1, wxEXPAND, 0);
    
    $self->{sz_colours} = Wx::FlexGridSizer->new(5, 4, 5, 5);
    $self->{sz_editor}->Add($self->{sz_colours}, 0, wxEXPAND, 0);
    
    $self->{cp_0} = Wx::ColourPickerCtrl->new($self->{nb_editor}, wxID_ANY);
    $self->{sz_colours}->Add($self->{cp_0}, 1, wxALIGN_CENTER_VERTICAL|wxEXPAND, 0);
    
    $self->{l_0} = Wx::StaticText->new($self->{nb_editor}, wxID_ANY, _T("Standard text"));
    $self->{sz_colours}->Add($self->{l_0}, 0, wxALIGN_CENTER_VERTICAL|wxEXPAND, 0);
    
    $self->{cp_bg} = Wx::ColourPickerCtrl->new($self->{nb_editor}, wxID_ANY);
    $self->{cp_bg}->Enable(0);
    $self->{sz_colours}->Add($self->{cp_bg}, 1, wxALIGN_CENTER_VERTICAL|wxEXPAND, 0);
    
    $self->{l_bg} = Wx::StaticText->new($self->{nb_editor}, wxID_ANY, _T("Background"));
    $self->{l_bg}->Enable(0);
    $self->{sz_colours}->Add($self->{l_bg}, 0, wxALIGN_CENTER_VERTICAL|wxEXPAND, 0);
    
    $self->{cp_1} = Wx::ColourPickerCtrl->new($self->{nb_editor}, wxID_ANY);
    $self->{sz_colours}->Add($self->{cp_1}, 1, wxALIGN_CENTER_VERTICAL|wxEXPAND, 0);
    
    $self->{l_1} = Wx::StaticText->new($self->{nb_editor}, wxID_ANY, _T("Comments"));
    $self->{sz_colours}->Add($self->{l_1}, 0, wxALIGN_CENTER_VERTICAL|wxEXPAND, 0);
    
    $self->{cp_2} = Wx::ColourPickerCtrl->new($self->{nb_editor}, wxID_ANY);
    $self->{sz_colours}->Add($self->{cp_2}, 1, wxALIGN_CENTER_VERTICAL|wxEXPAND, 0);
    
    $self->{l_2} = Wx::StaticText->new($self->{nb_editor}, wxID_ANY, _T("Keywords"));
    $self->{sz_colours}->Add($self->{l_2}, 0, wxALIGN_CENTER_VERTICAL|wxEXPAND, 0);
    
    $self->{cp_3} = Wx::ColourPickerCtrl->new($self->{nb_editor}, wxID_ANY);
    $self->{sz_colours}->Add($self->{cp_3}, 1, wxALIGN_CENTER_VERTICAL|wxEXPAND, 0);
    
    $self->{l_3} = Wx::StaticText->new($self->{nb_editor}, wxID_ANY, _T("Brackets"));
    $self->{sz_colours}->Add($self->{l_3}, 0, wxALIGN_CENTER_VERTICAL|wxEXPAND, 0);
    
    $self->{cp_4} = Wx::ColourPickerCtrl->new($self->{nb_editor}, wxID_ANY);
    $self->{sz_colours}->Add($self->{cp_4}, 1, wxALIGN_CENTER_VERTICAL|wxEXPAND, 0);
    
    $self->{l_4} = Wx::StaticText->new($self->{nb_editor}, wxID_ANY, _T("Chords"));
    $self->{sz_colours}->Add($self->{l_4}, 0, wxALIGN_CENTER_VERTICAL|wxEXPAND, 0);
    
    $self->{cp_5} = Wx::ColourPickerCtrl->new($self->{nb_editor}, wxID_ANY);
    $self->{sz_colours}->Add($self->{cp_5}, 1, wxALIGN_CENTER_VERTICAL|wxEXPAND, 0);
    
    $self->{l_5} = Wx::StaticText->new($self->{nb_editor}, wxID_ANY, _T("Directives"));
    $self->{sz_colours}->Add($self->{l_5}, 0, wxALIGN_CENTER_VERTICAL|wxEXPAND, 0);
    
    $self->{cp_6} = Wx::ColourPickerCtrl->new($self->{nb_editor}, wxID_ANY);
    $self->{sz_colours}->Add($self->{cp_6}, 1, wxALIGN_CENTER_VERTICAL|wxEXPAND, 0);
    
    $self->{l_6} = Wx::StaticText->new($self->{nb_editor}, wxID_ANY, _T("Arguments"));
    $self->{sz_colours}->Add($self->{l_6}, 0, wxALIGN_CENTER_VERTICAL|wxEXPAND, 0);
    
    $self->{cp_7} = Wx::ColourPickerCtrl->new($self->{nb_editor}, wxID_ANY);
    $self->{sz_colours}->Add($self->{cp_7}, 1, wxALIGN_CENTER_VERTICAL|wxEXPAND, 0);
    
    $self->{l_7} = Wx::StaticText->new($self->{nb_editor}, wxID_ANY, _T("Annotations"));
    $self->{sz_colours}->Add($self->{l_7}, 0, wxALIGN_CENTER_VERTICAL|wxEXPAND, 0);
    ...
    Wx::Event::EVT_COLOURPICKER_CHANGED($self, $self->{cp_0}->GetId, $self->can('OnColour0Changed'));
    Wx::Event::EVT_COLOURPICKER_CHANGED($self, $self->{cp_bg}->GetId, $self->can('OnBgColourChanged'));
    Wx::Event::EVT_COLOURPICKER_CHANGED($self, $self->{cp_1}->GetId, $self->can('OnColour1Changed'));
    Wx::Event::EVT_COLOURPICKER_CHANGED($self, $self->{cp_2}->GetId, $self->can('OnColour2Changed'));
    Wx::Event::EVT_COLOURPICKER_CHANGED($self, $self->{cp_3}->GetId, $self->can('OnColour3Changed'));
    Wx::Event::EVT_COLOURPICKER_CHANGED($self, $self->{cp_4}->GetId, $self->can('OnColour4Changed'));
    Wx::Event::EVT_COLOURPICKER_CHANGED($self, $self->{cp_5}->GetId, $self->can('OnColour5Changed'));
    Wx::Event::EVT_COLOURPICKER_CHANGED($self, $self->{cp_6}->GetId, $self->can('OnColour6Changed'));
    Wx::Event::EVT_COLOURPICKER_CHANGED($self, $self->{cp_7}->GetId, $self->can('OnColour7Changed'));
...
sub OnColour0Changed {
    my ($self, $event) = @_;
    # wxGlade: ChordPro::Wx::SettingsDialog_wxg::OnColour0Changed <event_handler>
    warn "Event handler (OnColour0Changed) not implemented";
    $event->Skip;
    # end wxGlade
}


sub OnBgColourChanged {
    my ($self, $event) = @_;
    # wxGlade: ChordPro::Wx::SettingsDialog_wxg::OnBgColourChanged <event_handler>
    warn "Event handler (OnBgColourChanged) not implemented";
    $event->Skip;
    # end wxGlade
}


sub OnColour1Changed {
    my ($self, $event) = @_;
    # wxGlade: ChordPro::Wx::SettingsDialog_wxg::OnColour1Changed <event_handler>
    warn "Event handler (OnColour1Changed) not implemented";
    $event->Skip;
    # end wxGlade
}


sub OnColour2Changed {
    my ($self, $event) = @_;
    # wxGlade: ChordPro::Wx::SettingsDialog_wxg::OnColour2Changed <event_handler>
    warn "Event handler (OnColour2Changed) not implemented";
    $event->Skip;
    # end wxGlade
}


sub OnColour3Changed {
    my ($self, $event) = @_;
    # wxGlade: ChordPro::Wx::SettingsDialog_wxg::OnColour3Changed <event_handler>
    warn "Event handler (OnColour3Changed) not implemented";
    $event->Skip;
    # end wxGlade
}


sub OnColour4Changed {
    my ($self, $event) = @_;
    # wxGlade: ChordPro::Wx::SettingsDialog_wxg::OnColour4Changed <event_handler>
    warn "Event handler (OnColour4Changed) not implemented";
    $event->Skip;
    # end wxGlade
}


sub OnColour5Changed {
    my ($self, $event) = @_;
    # wxGlade: ChordPro::Wx::SettingsDialog_wxg::OnColour5Changed <event_handler>
    warn "Event handler (OnColour5Changed) not implemented";
    $event->Skip;
    # end wxGlade
}


sub OnColour6Changed {
    my ($self, $event) = @_;
    # wxGlade: ChordPro::Wx::SettingsDialog_wxg::OnColour6Changed <event_handler>
    warn "Event handler (OnColour6Changed) not implemented";
    $event->Skip;
    # end wxGlade
}


sub OnColour7Changed {
    my ($self, $event) = @_;
    # wxGlade: ChordPro::Wx::SettingsDialog_wxg::OnColour7Changed <event_handler>
    warn "Event handler (OnColour7Changed) not implemented";
    $event->Skip;
    # end wxGlade
}
