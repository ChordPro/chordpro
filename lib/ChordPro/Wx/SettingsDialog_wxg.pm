# generated by wxGlade 1.1.0 on Fri Nov 29 22:34:13 2024
#
...
sub new {
    ...
    $label_1->SetMinSize($label_1->ConvertDialogSizeToPixels(Wx::Size->new(280, 11)));
    ...
    my $label_2 = Wx::StaticText->new($self->{nb_notations}, wxID_ANY, _T("Notations, Transpose and Transcode"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER_HORIZONTAL);
    $label_2->SetMinSize($label_2->ConvertDialogSizeToPixels(Wx::Size->new(-1, 11)));
    $label_2->SetForegroundColour(Wx::Colour->new(0, 104, 217));
    $label_2->SetFont(Wx::Font->new(18, wxDEFAULT, wxNORMAL, wxNORMAL, 0, ""));
    $self->{sizer_8}->Add($label_2, 0, wxALL|wxEXPAND, 15);
    ...
    $label_3->SetMinSize($label_3->ConvertDialogSizeToPixels(Wx::Size->new(-1, 11)));
    ...
    $label_4->SetMinSize($label_4->ConvertDialogSizeToPixels(Wx::Size->new(-1, 11)));
    ...
    $label_5->SetMinSize($label_5->ConvertDialogSizeToPixels(Wx::Size->new(-1, 11)));
    ...
    $self->{sz_prefs_outer}->Add($self->{w_infobar}, 0, wxEXPAND|wxLEFT|wxRIGHT, 5);
