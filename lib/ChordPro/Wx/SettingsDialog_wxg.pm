# generated by wxGlade 1.1.1 on Sat Apr  5 19:33:14 2025
#
...
sub new {
    ...
    my $label_1 = Wx::StaticText->new($self->{nb_config}, wxID_ANY, _T("Instrument, Style and Presets"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER_HORIZONTAL);
    ...
    my $l_instrument_desc = Wx::StaticText->new($self->{nb_config}, wxID_ANY, _T("6-string guitar in standard tuning."));
    $l_instrument_desc->Wrap(250);
    $self->{sz_instrument}->Add($l_instrument_desc, 0, wxEXPAND, 0);
    ...
    $self->{sz_style}->Add($self->{l_style_desc}, 0, wxEXPAND, 0);
    
    $self->{sz_extra} = Wx::BoxSizer->new(wxVERTICAL);
    $self->{sz_presets}->Add($self->{sz_extra}, Wx::GBPosition->new(0, 2), Wx::GBSpan->new(1, 1), wxEXPAND, 0);
    
    $self->{l_extra1} = Wx::StaticText->new($self->{nb_config}, wxID_ANY, _T("Modifiers"));
    $self->{l_extra1}->SetFont(Wx::Font->new(11, wxDEFAULT, wxNORMAL, wxBOLD, 0, ""));
    $self->{sz_extra}->Add($self->{l_extra1}, 0, wxBOTTOM, 5);
    
    $self->{ch_extra1} = Wx::Choice->new($self->{nb_config}, wxID_ANY, wxDefaultPosition, wxDefaultSize, [_T("Two Columns")], );
    $self->{ch_extra1}->SetMinSize(Wx::Size->new(250, -1));
    $self->{ch_extra1}->SetSelection(0);
    $self->{sz_extra}->Add($self->{ch_extra1}, 0, wxBOTTOM|wxEXPAND, 5);
    
    $self->{l_extra1_desc} = Wx::StaticText->new($self->{nb_config}, wxID_ANY, _T("Organize the lyrics and chords in two columns."));
    $self->{l_extra1_desc}->Wrap(250);
    $self->{sz_extra}->Add($self->{l_extra1_desc}, 0, wxEXPAND|wxTOP, 0);
    
    $self->{ch_extra2} = Wx::CheckListBox->new($self->{nb_config}, wxID_ANY, wxDefaultPosition, wxDefaultSize, [_T("None"), _T("Inline chords"), _T("Two columns"), _T("Dark mode"), _T("xxx")], );
    $self->{ch_extra2}->SetMinSize(Wx::Size->new(250, -1));
    $self->{ch_extra2}->Show(0);
    $self->{ch_extra2}->SetMaxSize($self->{ch_extra2}->ConvertDialogSizeToPixels(Wx::Size->new(250, 55)));
    $self->{sz_extra}->Add($self->{ch_extra2}, 0, wxEXPAND, 0);
    ...
    $self->{cb_editorlines} = Wx::CheckBox->new($self->{nb_editor}, wxID_ANY, _T("Show Line Numbers"));
    $self->{cb_editorlines}->SetToolTipString(_T("Hide or show line numbers."));
    $self->{sizer_10}->Add($self->{cb_editorlines}, Wx::GBPosition->new(1, 0), Wx::GBSpan->new(1, 1), wxALIGN_CENTER_VERTICAL|wxEXPAND, 0);
    
    my $label_2 = Wx::StaticText->new($self->{nb_editor}, wxID_ANY, _T("Line numbers are only shown when the messages panel is visible."));
    $self->{sizer_10}->Add($label_2, Wx::GBPosition->new(1, 1), Wx::GBSpan->new(1, 1), wxALIGN_CENTER_VERTICAL, 0);
    ...
    $self->{sizer_10}->Add($self->{cb_editorwrap}, Wx::GBPosition->new(2, 0), Wx::GBSpan->new(1, 1), wxALIGN_CENTER_VERTICAL, 0);
    
    $self->{sz_editor_12} = Wx::BoxSizer->new(wxHORIZONTAL);
    $self->{sizer_10}->Add($self->{sz_editor_12}, Wx::GBPosition->new(2, 1), Wx::GBSpan->new(1, 1), wxEXPAND, 0);
    ...
    $self->{sizer_10}->Add($self->{l_prefext}, Wx::GBPosition->new(4, 0), Wx::GBSpan->new(1, 1), wxALIGN_CENTER_VERTICAL, 0);
    ...
    $self->{sizer_10}->Add($self->{t_prefext}, Wx::GBPosition->new(4, 1), Wx::GBSpan->new(1, 1), wxEXPAND, 0);
    ...
    $self->{sizer_10}->Add($self->{cb_tmplfile}, Wx::GBPosition->new(5, 0), Wx::GBSpan->new(1, 1), wxALIGN_CENTER_VERTICAL|wxEXPAND, 5);
    ...
    $self->{sizer_10}->Add($self->{fp_tmplfile}, Wx::GBPosition->new(5, 1), Wx::GBSpan->new(1, 1), wxEXPAND, 0);
    ...
    Wx::Event::EVT_CHOICE($self, $self->{ch_extra1}->GetId, $self->can('OnChangeExtra1'));
    Wx::Event::EVT_CHECKLISTBOX($self, $self->{ch_extra2}->GetId, $self->can('OnChangeExtra2'));
    ...
    Wx::Event::EVT_CHECKBOX($self, $self->{cb_editorlines}->GetId, $self->can('OnEditorLineNumbers'));
...
sub OnChangeExtra1 {
    my ($self, $event) = @_;
    # wxGlade: ChordPro::Wx::SettingsDialog_wxg::OnChangeExtra1 <event_handler>
    warn "Event handler (OnChangeExtra1) not implemented";
    $event->Skip;
    # end wxGlade
}
...
sub OnChangeExtra2 {
    my ($self, $event) = @_;
    # wxGlade: ChordPro::Wx::SettingsDialog_wxg::OnChangeExtra2 <event_handler>
    warn "Event handler (OnChangeExtra2) not implemented";
    $event->Skip;
    # end wxGlade
}
...
sub OnEditorLineNumbers {
    my ($self, $event) = @_;
    # wxGlade: ChordPro::Wx::SettingsDialog_wxg::OnEditorLineNumbers <event_handler>
    warn "Event handler (OnEditorLineNumbers) not implemented";
    $event->Skip;
    # end wxGlade
}
