# generated by wxGlade 1.1.1 on Sat Aug 29 08:44:22 2026
#
...
sub new {
    ...
    $self->{sizer_3}->Add($self->{sizer_12}, 0, 0, 0);
    
    $self->{rb_preview_pdf} = Wx::RadioButton->new($self->{nb_preview}, wxID_ANY, _T("Preview PDF"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP);
    ...
    $self->{cb_live_preview_pdf} = Wx::CheckBox->new($self->{nb_preview}, wxID_ANY, _T("Live preview (experimental)"));
    $self->{sizer_12}->Add($self->{cb_live_preview_pdf}, Wx::GBPosition->new(0, 1), Wx::GBSpan->new(1, 1), wxALIGN_CENTER_VERTICAL|wxTOP, 5);
    
    my $label_2 = Wx::StaticText->new($self->{nb_preview}, wxID_ANY, _T("By default ChordPro will use a built-in viewer to preview the generated PDF output.\n\nIn case you want a different viewer, check the checkbox and fill in the command required to run the alternative PDF viewer."));
    $label_2->Wrap(750);
    $self->{sizer_12}->Add($label_2, Wx::GBPosition->new(1, 1), Wx::GBSpan->new(1, 1), 0, 40);
    
    $self->{sizer_7} = Wx::BoxSizer->new(wxHORIZONTAL);
    $self->{sizer_12}->Add($self->{sizer_7}, Wx::GBPosition->new(2, 1), Wx::GBSpan->new(1, 1), wxEXPAND, 0);
    ...
    $self->{sizer_7}->Add($self->{cb_pdfviewer}, 0, wxALIGN_CENTER_VERTICAL, 40);
    ...
    $self->{sizer_7}->Add($self->{t_pdfviewer}, 1, wxALL|wxEXPAND, 5);
    
    my $label_9 = Wx::StaticText->new($self->{nb_preview}, wxID_ANY, _T("In the command:\n    %f will be replaced by the file name of the PDF preview file\n    %u will be replaced by the URL of the PDF preview file\n"), wxDefaultPosition, wxDefaultSize, wxALIGN_LEFT);
    $label_9->Wrap(750);
    $self->{sizer_12}->Add($label_9, Wx::GBPosition->new(3, 1), Wx::GBSpan->new(1, 1), wxEXPAND, 40);
    
    $self->{rb_preview_html} = Wx::RadioButton->new($self->{nb_preview}, wxID_ANY, _T("Preview HTML"));
    $self->{rb_preview_html}->SetMinSize(Wx::Size->new(130, -1));
    $self->{sizer_12}->Add($self->{rb_preview_html}, Wx::GBPosition->new(4, 0), Wx::GBSpan->new(1, 1), wxLEFT|wxTOP, 5);
    
    $self->{cb_live_preview_html} = Wx::CheckBox->new($self->{nb_preview}, wxID_ANY, _T("Live preview (experimental)"));
    $self->{sizer_12}->Add($self->{cb_live_preview_html}, Wx::GBPosition->new(4, 1), Wx::GBSpan->new(1, 1), wxTOP, 5);
    
    $self->{sizer_8} = Wx::BoxSizer->new(wxHORIZONTAL);
    $self->{sizer_12}->Add($self->{sizer_8}, Wx::GBPosition->new(5, 1), Wx::GBSpan->new(1, 1), wxEXPAND, 0);
    
    $self->{rb_html_previewer} = Wx::RadioBox->new($self->{nb_preview}, wxID_ANY, _T("Select the HTML builder to use."), wxDefaultPosition, wxDefaultSize, [_T("Classic HTML"), _T("Advanced HTML (experimental)")], 2, wxRA_SPECIFY_ROWS);
    $self->{rb_html_previewer}->Enable(0);
    $self->{rb_html_previewer}->SetSelection(0);
    $self->{sizer_8}->Add($self->{rb_html_previewer}, 0, wxALIGN_CENTER_VERTICAL, 40);
    
    $self->{sizer_8}->Add(10, 1, 1, wxEXPAND, 0);
    
    $self->{rb_html_exporter} = Wx::RadioBox->new($self->{nb_preview}, wxID_ANY, _T("Select the method for Export Preview."), wxDefaultPosition, wxDefaultSize, [_T("HTML"), _T("PDF (print dialog)")], 2, wxRA_SPECIFY_ROWS);
    $self->{rb_html_exporter}->SetSelection(0);
    $self->{sizer_8}->Add($self->{rb_html_exporter}, 0, wxALIGN_CENTER_VERTICAL, 40);
