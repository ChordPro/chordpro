# generated by wxGlade 1.1.0pre on Thu Feb  3 09:49:04 2022
#
...
sub new {
    ...
    $self->{t_customlibdialog} = Wx::TextCtrl->new($self, wxID_ANY, "");
    ...
    $self->{t_tmplfiledialog} = Wx::TextCtrl->new($self, wxID_ANY, "");
