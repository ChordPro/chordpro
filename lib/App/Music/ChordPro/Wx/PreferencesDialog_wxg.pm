#!/usr/bin/perl -w -- 
#
# generated by wxGlade 0.7.2 on Wed Jan 18 14:01:15 2017
#
...
sub __set_properties {
    ...
    $self->{b_configfiledialog}->SetMinSize($self->{b_configfiledialog}->ConvertDialogSizeToPixels(Wx::Size->new(16, 14)));
