#!/usr/bin/perl -w -- 
#
# generated by wxGlade 0.7.2 on Tue Jan 17 11:30:25 2017
#
...
sub new {
    ...
    $self->{b_configfiledialog} = Wx::BitmapButton->new($self, wxID_ANY, Wx::Bitmap->new("/home/jv/tmp/dots.png", wxBITMAP_TYPE_ANY));
...
sub __set_properties {
    ...
    $self->{b_configfiledialog}->SetSize($self->{b_configfiledialog}->GetBestSize());
    $self->{b_configfiledialog}->SetDefault();
...
sub __do_layout {
    ...
    $self->{sz_prefs_outer}->SetSizeHints($self);
    $self->Layout();
    # end wxGlade
}
