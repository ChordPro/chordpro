# generated by wxGlade 0.9.0pre on Sat Oct  3 15:42:40 2020
#
...
sub OnHelp_Example {
    my ($self, $event) = @_;
    # wxGlade: App::Music::ChordPro::Wx::Main_wxg::OnHelp_Example <event_handler>
...
sub OnHelp_DebugInfo {
    my ($self, $event) = @_;
    # wxGlade: App::Music::ChordPro::Wx::Main_wxg::OnHelp_DebugInfo <event_handler>
...
sub OnText {
    my ($self, $event) = @_;
    # wxGlade: App::Music::ChordPro::Wx::Main_wxg::OnText <event_handler>
